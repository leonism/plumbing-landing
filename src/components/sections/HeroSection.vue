  ...
  <section
    ...
    <div
      ...
      <div
        ...
        <span class="inline-flex items-center gap-1">
          <i class="fa-solid fa-shield-heart text-blue-500"></i> Licensed &
          Insured
        </span>
      </div>
    </div>
    ...
    <div class="flex-1 w-full flex justify-center items-center relative">
      <div class="relative w-full max-w-sm sm:max-w-md md:max-w-lg">
        <img
          ...
          class="rounded-3xl shadow-2xl object-cover w-full border-4 border-white dark:border-neutral-900 bg-white/30 dark:bg-neutral-900/30 transition-all duration-300" />
        <div
