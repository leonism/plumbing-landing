  ...
  <nav
    ...
    <div
      ...
      <router-link
        ...
        <span
          class="font-display text-xl md:text-2xl font-extrabold bg-gradient-to-r from-red-600 via-orange-500 to-red-700 dark:from-red-500 dark:via-orange-400 dark:to-red-600 bg-clip-text text-transparent drop-shadow-lg">
          Manhattan Plumbing
        </span>
      </router-link>
      ...
      <ul class="hidden md:flex items-center gap-6 text-base font-medium">
        <li
          ...
          <router-link
            ...
            :class="{
              'text-primary-600 dark:text-primary-400': isCurrentRoute(item.to),
      ...
      <div class="flex items-center gap-4 md:gap-6">
        ...
        <button
          ...
          :aria-expanded="showMobile.toString()"
    ...
    <div
      ...
      <ul class="flex flex-col gap-4 text-base font-medium">
        <li
          ...
          <router-link
            :to="item.to"
            class="block px-2 py-1.5 rounded transition-all hover:text-primary-600 dark:hover:text-primary-400 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-400"
            :class="{
              'text-primary-600 dark:text-primary-400': isCurrentRoute(item.to),
              'text-neutral-700 dark:text-neutral-300': !isCurrentRoute(
                item.to
